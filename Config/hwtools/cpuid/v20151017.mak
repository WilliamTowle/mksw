# cpuid v20151017		[ since v20150505, c.2015-06-10 ]
...
CPUID_SRC=${SOURCES}/c/cpuid-${CPUID_VERSION}.src.tar.gz
URLS+= http://etallen.com/cpuid/cpuid-${CPUID_VERSION}.src.tar.gz
