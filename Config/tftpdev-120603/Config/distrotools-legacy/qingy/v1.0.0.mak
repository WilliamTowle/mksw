...
#CUI_QINGY_VER:=0.9.9
CUI_QINGY_VER:=1.0.0
CUI_QINGY_SRC=${SRCDIR}/q/qingy-${CUI_QINGY_VER}.tar.bz2
CUI_QINGY_PATCHES=

URLS+=http://downloads.sourceforge.net/project/qingy/qingy/qingy%20${CUI_QINGY_VER}/qingy-${CUI_QINGY_VER}.tar.bz2?use_mirror=freefr
