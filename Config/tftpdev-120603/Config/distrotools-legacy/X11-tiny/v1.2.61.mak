...
# last mod WmT, 2011-05-03	[ (c) and GPLv2 1999-2011 ]
...
${CUI_X11_TINY_CONFIGURED}:
	...
	( cd ${EXTTEMP}/${CUI_X11_TINY_TEMP} || exit 1 ;\
		...
		cat config/cf/kdrive.cf.OLD \
			| sed '/define BuildBuiltinFonts/ s/NO/YES/' \
			| sed '/define Build75Dpi/ s/NO/YES/' \
...
${CUI_X11_TINY_INSTALLED}:
	...
	( cd ${EXTTEMP}/${CUI_X11_TINY_TEMP} || exit 1 ;\
		make install DESTDIR=${CUI_X11_TINY_INSTTEMP} \
	)
