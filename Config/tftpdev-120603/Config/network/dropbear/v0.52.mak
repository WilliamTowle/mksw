# dropbear v0.52		[ since v0.43, c.2004-10-16 ]
...
DROPBEAR_VER:=0.52
DROPBEAR_SRC=${SRCDIR}/d/dropbear-0.52.tar.bz2
DROPBEAR_PATCHES=

URLS+=http://matt.ucc.asn.au/dropbear/releases/dropbear-0.52.tar.bz2
