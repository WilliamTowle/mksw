...
FAKEROOT_NG_VER=0.17
#FAKEROOT_NG_SRC=${SRCDIR}/f/fakeroot-ng_${FAKE_ROOT_NG_VER}.orig.tar.gz
FAKEROOT_NG_SRC=${SRCDIR}/f/fakeroot-ng-${FAKEROOT_NG_VER}.tar.gz

#URLS+= http://www.mirrorservice.org/sites/archive.ubuntu.com/ubuntu/pool/universe/f/fakeroot-ng/fakeroot-ng_0.16.orig.tar.gz
URLS+= "http://downloads.sourceforge.net/project/fakerootng/fakeroot-ng/${FAKEROOT_NG_VER}/fakeroot-ng-${FAKEROOT_NG_VER}.tar.gz?r=http%3A%2F%2Fsourceforge.net%2Fprojects%2Ffakerootng%2Ffiles%2F&ts=1325973116&use_mirror=ignum"
...
NTI_FAKEROOT_NG_BUILT=${EXTTEMP}/${NTI_FAKEROOT_NG_TEMP}/fakeroot-ng
...
NTI_FAKEROOT_NG_INSTALLED=${NTI_TC_ROOT}/usr/bin/fakeroot-ng
