# sysstat 10.0.1		[ EARLIEST v4.1.7, c.2003-10-06 ]
# last mod WmT, 2011-06-07	[ (c) and GPLv2 1999-2011 ]
...
#URLS+=ftp://ibiblio.org/pub/linux/system/status/sysstat-${SYSSTAT_VER}.tar.gz
URLS+=http://pagesperso-orange.fr/sebastien.godard/sysstat-${SYSSTAT_VER}.tar.gz
...
.PHONY: nti-sysstat
nti-sysstat: nti-native-gcc nti-sysstat-installed
