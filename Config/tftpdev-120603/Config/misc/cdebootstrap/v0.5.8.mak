# cdebootstrap v0.5.8		[ since v0.5.7, c.2011-09-02 ]
...
CUI_CDEBOOTSTRAP_VER:=0.5.8
#CUI_CDEBOOTSTRAP_SRC=${SRCDIR}/c/cdebootstrap_0.5.7ubuntu2.tar.gz
CUI_CDEBOOTSTRAP_SRC=${SRCDIR}/c/cdebootstrap_0.5.8ubuntu1.tar.gz
...
URLS+= http://www.mirrorservice.org/sites/archive.ubuntu.com/ubuntu/pool/universe/c/cdebootstrap/cdebootstrap_0.5.8ubuntu1.tar.gz
...
ifneq (${CUI_CDEBOOTSTRAP_PATCHES},)
	...
	mv ${EXTTEMP}/cdebootstrap-${CUI_CDEBOOTSTRAP_VER} ${EXTTEMP}/${CUI_CDEBOOTSTRAP_TEMP}
