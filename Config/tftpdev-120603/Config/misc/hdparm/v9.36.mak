# hdparm v9.36			[ EARLIEST v5.2, c.2002-11-08 ]
...
HDPARM_VER=9.36
HDPARM_SRC=${SRCDIR}/h/hdparm-9.36.tar.gz

URLS+= http://downloads.sourceforge.net/project/hdparm/hdparm/hdparm-9.36.tar.gz?r=http%3A%2F%2Fsourceforge.net%2Fprojects%2Fhdparm%2F&ts=1289903569&use_mirror=ovh
...
NTI_HDPARM_BUILT=${EXTTEMP}/${NTI_HDPARM_TEMP}/faked
...
NTI_HDPARM_INSTALLED=${NTI_TC_ROOT}/usr/bin/faked
