# debootstrap v1.0.37		[ since v1.0.36, c.2011-09-02 ]
...
CUI_DEBOOTSTRAP_VER:=1.0.37
CUI_DEBOOTSTRAP_SRC=${SRCDIR}/d/debootstrap_${CUI_DEBOOTSTRAP_VER}.tar.gz
CUI_DEBOOTSTRAP_PATCHES=

URLS+= http://www.mirrorservice.org/sites/archive.ubuntu.com/ubuntu/pool/main/d/debootstrap/debootstrap_${CUI_DEBOOTSTRAP_VER}.tar.gz
