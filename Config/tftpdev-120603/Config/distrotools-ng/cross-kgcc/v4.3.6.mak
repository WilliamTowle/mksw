# cross-kgcc v4.3.6		[ since v2.7.2.3, c.2002-10-14 ]
...
ifneq (${GMP_VER},)
	mv ${EXTTEMP}/gmp-${GMP_VER} ${EXTTEMP}/gcc-${CTI_CROSS_KGCC_VER}/gmp
endif
ifneq (${MPFR_VER},)
	mv ${EXTTEMP}/mpfr-${MPFR_VER} ${EXTTEMP}/gcc-${CTI_CROSS_KGCC_VER}/mpfr
endif
