...
ifneq (${GMP_VER},)
	mv ${EXTTEMP}/gmp-${GMP_VER} ${EXTTEMP}/gcc-${NTI_NATIVE_GCC_VER}/gmp
endif
ifneq (${MPFR_VER},)
	mv ${EXTTEMP}/mpfr-${MPFR_VER} ${EXTTEMP}/gcc-${NTI_NATIVE_GCC_VER}/mpfr
endif
...
NTI_NATIVE_GCC_BUILT=${EXTTEMP}/${NTI_NATIVE_GCC_TEMP}/host-${NTI_SPEC}/gcc
