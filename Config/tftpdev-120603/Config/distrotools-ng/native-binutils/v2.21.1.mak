# native-binutils v2.21.1	[ since v2.9.1, c.2002-10-04 ]
# last mod WmT, 2012-01-08	[ (c) and GPLv2 1999-2012 ]
...
ifeq (${NATIVE_BINUTILS_VER},2.21.1)
NATIVE_BINUTILS_PATCHES+=${SRCDIR}/b/binutils-2.21.1-patches-1.4.tar.bz2
URLS+= http://www.mirrorservice.org/sites/www.ibiblio.org/gentoo/distfiles/binutils-2.21.1-patches-1.4.tar.bz2
#NATIVE_BINUTILS_PATCHES+=${SRCDIR}/b/binutils-2.19.1-uclibc-patches-1.0.tar.bz2
#URLS+= http://www.mirrorservice.org/sites/www.ibiblio.org/gentoo/distfiles/binutils-2.19.1-uclibc-patches-1.0.tar.bz2
endif
