# cross-binutils v2.16.1	[ since v2.9.1, c.2002-10-14 ]
...
include ${CFG_ROOT}/distrotools-ng/native-gcc/v2.95.3.mak
...
CROSS_BINUTILS_PATCHES+=${SRCDIR}/b/binutils-2.16.1-patches-1.11.tar.bz2
URLS+=http://www.mirrorservice.org/sites/www.ibiblio.org/gentoo/distfiles/binutils-2.16.1-patches-1.11.tar.bz2
CROSS_BINUTILS_PATCHES+=${SRCDIR}/b/binutils-2.16.1-uclibc-patches-1.1.tar.bz2
