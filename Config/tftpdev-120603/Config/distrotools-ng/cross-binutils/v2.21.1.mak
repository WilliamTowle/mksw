# cross-binutils v2.21.1	[ since v2.9.1, c.2002-10-14 ]
...
CROSS_BINUTILS_VER:=${HAVE_CROSS_BINUTILS_VER}
...
ifeq (${CROSS_BINUTILS_VER},2.21.1)
CROSS_BINUTILS_PATCHES+=${SRCDIR}/b/binutils-2.21.1-patches-1.4.tar.bz2
