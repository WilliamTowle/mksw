# cross-binutils v2.22		[ since v2.9.1, c.2002-10-14 ]
...
ifeq (${CROSS_BINUTILS_VER},2.22)
CROSS_BINUTILS_PATCHES+=${SRCDIR}/b/binutils-2.22-patches-1.0.tar.bz2
URLS+= http://www.mirrorservice.org/sites/www.ibiblio.org/gentoo/distfiles/binutils-2.22-patches-1.0.tar.bz2
#CROSS_BINUTILS_PATCHES+=${SRCDIR}/b/binutils-2.22-uclibc-patches-1.0.tar.bz2
