...
URLS+=http://www.mirrorservice.org/sites/ftp.gnu.org/gnu/binutils/binutils/binutils-${CROSS_BINUTILS_VER}.tar.bz2
...
CTI_CROSS_BINUTILS_BUILT=${EXTTEMP}/${CTI_CROSS_BINUTILS_TEMP}/host-${NTI_SPEC}/binutils/ar
