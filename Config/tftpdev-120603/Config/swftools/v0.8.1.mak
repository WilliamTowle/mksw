# swftools v0.8.1		[ since v0.8.1 2010-01-21 ]
...
#SWFTOOLS_VER=0.9.0	# build error
SWFTOOLS_VER=0.8.1
SWFTOOLS_SRC=${SRCDIR}/s/swftools-0.8.1.tar.gz

URLS+= http://www.swftools.org/swftools-0.8.1.tar.gz
...
HTC_SWFTOOLS_BUILT=${EXTTEMP}/${HTC_SWFTOOLS_TEMP}/src/font2swf
...
HTC_SWFTOOLS_INSTALLED=${HTC_ROOT}/usr/bin/font2swf
