# xkeyboard-config v2.1		[ since v2.1, c.2013-04-14 ]
...
include ${CFG_ROOT}/x11-r7.5/xkbcomp/v1.1.1.mak
include ${CFG_ROOT}/misc/gettext/v0.18.2.mak
...
${NTI_XKEYBOARD_CONFIG_CONFIGURED}: ${NTI_XKEYBOARD_CONFIG_EXTRACTED}
	...
	( cd ${EXTTEMP}/${NTI_XKEYBOARD_CONFIG_TEMP} || exit 1 ;\
	  PATH=${NTI_TC_ROOT}/usr/X11R7/bin:${PATH} \
	  CFLAGS='-O2' \
...
## 2013-04-27: attempt LD_LIBRARY_PATH
...
nti-xkeyboard-config: nti-pkg-config nti-x11proto nti-xkbcomp nti-gettext nti-intltool nti-libiconv nti-XML-Parser ${NTI_XKEYBOARD_CONFIG_INSTALLED}
