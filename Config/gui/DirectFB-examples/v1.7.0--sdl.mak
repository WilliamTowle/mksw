# DirectFB-examples v1.7.0	[ EARLIEST v1.7.0, c.2014-05-28 ]
...
URLS+= http://sources.buildroot.net/DirectFB-examples-1.7.0.tar.gz

#include ${CFG_ROOT}/gui/DirectFB/v1.7.7.mak
include ${CFG_ROOT}/gui/DirectFB/v1.7.7--sdl.mak
#include ${CFG_ROOT}/misc/zlib/v1.2.8.mak

NTI_DIRECTFB_EXAMPLES_TEMP=nti-DirectFB-examples-${DIRECTFB_EXAMPLES_VERSION}

NTI_DIRECTFB_EXAMPLES_EXTRACTED=${EXTTEMP}/${NTI_DIRECTFB_EXAMPLES_TEMP}/COPYING
...
NTI_DIRECTFB_EXAMPLES_INSTALLED=${NTI_TC_ROOT}/usr/bin/df_andi
...
## df_stereo3d requires DirectFB v1.5.3+ (not dependency-checked)
...
#		  ZLIB_LIBS=` ${NTI_TC_ROOT}/usr/bin/${HOSTSPEC}-pkg-config --libs zlib ` \
...
nti-DirectFB-examples: \
	nti-libtool nti-pkg-config \
	nti-SDL nti-DirectFB \
	${NTI_DIRECTFB_EXAMPLES_INSTALLED}
