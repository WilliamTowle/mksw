# SDL v2.0.3			[ EARLIEST v?.?? ]
# last mod WmT, 2014-06-12	[ (c) and GPLv2 1999-2014* ]
...
NTI_SDL2_EXTRACTED=${EXTTEMP}/${NTI_SDL2_TEMP}/Makefile
NTI_SDL2_CONFIGURED=${EXTTEMP}/${NTI_SDL2_TEMP}/config.log
