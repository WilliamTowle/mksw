# xcb-util v0.3.8			[ since v0.2, c.2017-04-13 ]
...
NTI_XCB_UTIL_BUILT=${EXTTEMP}/${NTI_XCB_UTIL_TEMP}/xcb-atom.pc
...
.PHONY: nti-xcb-util
#nti-xcb-util: nti-pkg-config nti-libX11 nti-libxkbfile ${NTI_XCB_UTIL_INSTALLED}
