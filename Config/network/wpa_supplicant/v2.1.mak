# wpa_supplicant v2.1		[ since v2.1, c.2014-03-27 ]
# last mod WmT, 2014-04-12	[ (c) and GPLv2 1999-2014 ]
...
#include ${CFG_ROOT}/network/openssl/v1.0.1g.mak
...
URLS+= http://hostap.epitest.fi/releases/wpa_supplicant-2.1.tar.gz
