# wpa_supplicant v2.4		[ since v2.1, c.2014-03-27 ]
# last mod WmT, 2015-04-05	[ (c) and GPLv2 1999-2015 ]
...
#include ${CFG_ROOT}/misc/openssl/v1.0.1j.mak
#include ${CFG_ROOT}/network/openssl/v1.0.2.mak
