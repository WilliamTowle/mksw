# libnl v3.2.24			[ since v1.8.2, c.2003-06-07 ]
# last mod WmT, 2014-04-08	[ (c) and GPLv2 1999-2014* ]
...
URLS+= http://www.carisma.slowglass.com/~tgr/libnl/files/libnl-3.2.24.tar.gz
...
.PHONY: nti-libnl
nti-libnl: nti-bison nti-flex ${NTI_LIBNL_INSTALLED}
