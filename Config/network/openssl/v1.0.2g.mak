# openssl v1.0.2g		[ since v0.9.7b, c.2003-05-28 ]
# last mod WmT, 2016-03-01	[ (c) and GPLv2 1999-2016* ]

## 2014-01-20: bad POD breaks 'install_docs' rule (v1.0.1f)
## 2014-04-08: SHOULD build with -DOPENSSL_NO_HEARTBEATS for <= v1.0.1g
## 2015-07-10: 1.0.2b+ obsoleted by 1.0.2d
...
URLS+= ftp://ftp.openssl.org/source/openssl-${OPENSSL_VERSION}.tar.gz
#URLS+= ftp://ftp.openssl.org/source/old/1.0.2/openssl-${OPENSSL_VERSION}.tar.gz
...
## [2016-02-01] Preliminary 'make depend' mandatory in v1.0.2e+
