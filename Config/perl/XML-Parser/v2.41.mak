# XML::Parser v2.41		[ since v2.41, c.2013-04-22 ]
...
XML_PARSER_SRC=${SOURCES}/x/XML-Parser-2.41.tar.gz

URLS+= http://search.cpan.org/CPAN/authors/id/T/TO/TODDR/XML-Parser-2.41.tar.gz
...
NTI_XML_PARSER_CONFIGURED=${EXTTEMP}/${NTI_XML_PARSER_TEMP}/Makefile.PL.OLD
