# qemu v0.15.1			[ since v0.8.2, c.200?-??-?? ]
...
URLS+= http://wiki.qemu-project.org/download/qemu-0.13.0.tar.gz
...
# tweaks:
# - removed --cc=${NUI_CC_PREFIX}cc
# - set for zlib: --extra-cflags/--extra-ldflags
