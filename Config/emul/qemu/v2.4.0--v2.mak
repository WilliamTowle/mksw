# qemu v2.4.0			[ since v0.8.2, c.200?-??-?? ]
# last mod W1T, 2016-01-18	[ (c) and GPLv2 1999-2016* ]
		...
		1.5.2) \
		  sdl=yes sdl_config=${NTI_TC_ROOT}'/usr/bin/sdl-config' \
			./configure \
				...
				|| exit 1 \
		;; \
		2.0.0|2.2.0-rc2|2.2.[01]|2.3.0|2.4.0) \
		  sdl=yes sdl_config=${NTI_TC_ROOT}'/usr/bin/sdl-config' \
...
.PHONY: nti-qemu
nti-qemu: nti-libtool nti-pkg-config \
	nti-autoconf nti-automake nti-bison nti-flex \
	nti-gettext nti-glib nti-zlib ${NTI_QEMU_INSTALLED}
