# x11proto-fixes v4.1.2		[ since v4.1.1, c.2013-03-03 ]
...
URLS+= http://www.x.org/releases/X11R7.6/src/proto/fixesproto-${X11PROTO_FIXES_VERSION}.tar.bz2
