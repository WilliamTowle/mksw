# libXt v1.0.9			[ since v1.0.5 c.2009-09-08 ]
...
URLS+= http://www.x.org/releases/X11R7.6/src/lib/libXt-1.0.9.tar.bz2

include ${CFG_ROOT}/buildtools/pkg-config/v0.23.mak
#include ${CFG_ROOT}/buildtools/pkg-config/v0.27.1.mak

#include ${CFG_ROOT}/gui/libSM/v1.1.1.mak
include ${CFG_ROOT}/x11-r7.6/libSM/v1.2.0.mak
