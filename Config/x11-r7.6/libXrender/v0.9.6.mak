...
URLS+= http://www.x.org/releases/X11R7.6/src/lib/libXrender-${LIBXRENDER_VERSION}.tar.bz2
...
#include ${CFG_ROOT}/gui/x11proto-render/v0.11.mak
...
#		cp ${NTI_TC_ROOT}/usr/lib/pkgconfig/xrender.pc ${NTI_LIBXRENDER_INSTALLED} \
