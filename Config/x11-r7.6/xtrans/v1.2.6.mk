# xtrans v1.2.6			[ since v1.2, c. 2008-06-12 ]
...
XTRANS_URL+= http://www.x.org/releases/X11R7.6/src/lib/xtrans-${XTRANS_VERSION}.tar.bz2
...
${NTI_XTRANS_EXTRACTED}: | nti-sanity ${XTRANS_SRC}
	echo "*** $@ (EXTRACT) ***"
