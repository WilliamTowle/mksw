## xz v5.2.3			[ since v5.0.5, c.2014-01-08 ]
...
${NTI_XZ_CONFIGURED}: ${NTI_XZ_EXTRACTED}
	...
	( cd ${EXTTEMP}/${NTI_XZ_TEMP} || exit 1 ;\
		[ -r src/liblzma/Makefile.in.OLD ] || mv src/liblzma/Makefile.in src/liblzma/Makefile.in.OLD || exit 1 ;\
		cat src/liblzma/Makefile.in.OLD \
