# glib v2.55.2			[ earliest v2.26.1, c.2011-09-08 ]
...
#URLS+= http://ftp.gnome.org/pub/gnome/sources/glib/2.52/glib-${GLIB_VERSION}.tar.xz
URLS+= http://ftp.gnome.org/pub/gnome/sources/glib/2.55/glib-${GLIB_VERSION}.tar.xz

include ${CFG_ROOT}/misc/gettext/v0.19.8.1.mak
