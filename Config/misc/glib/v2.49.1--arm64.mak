# glib v2.49.1			[ earliest v2.26.1, c.2011-09-08 ]
...
URLS+= http://ftp.gnome.org/pub/gnome/sources/glib/2.49/glib-${GLIB_VERSION}.tar.xz

include ${CFG_ROOT}/misc/gettext/v0.18.2--arm64.mak
#include ${CFG_ROOT}/misc/libiconv/v1.14--arm64.mak
include ${CFG_ROOT}/misc/libffi/v3.2.1--arm64.mak
...
cti-glib: cti-pkg-config \
	...
	${CTI_GLIB_INSTALLED}
#	nti-libffi nti-libiconv nti-zlib nti-gettext ${NTI_GLIB_INSTALLED}
...
nti-glib: nti-pkg-config \
	nti-libffi nti-gettext nti-zlib \
	${NTI_GLIB_INSTALLED}
#	nti-libffi nti-libiconv nti-zlib nti-gettext ${NTI_GLIB_INSTALLED}
