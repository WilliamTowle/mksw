# linux v3.6.11			[ EARLIEST v?.??, c.????-??-?? ]
# last mod WmT, 2013-04-28	[ (c) and GPLv2 1999-2013 ]
...
URLS+= https://www.kernel.org/pub/linux/kernel/v3.0/linux-${LINUX_VERSION}.tar.bz2

include ${CFG_ROOT}/tui/bash/v4.2.mak
...
${NTI_LINUX_BUILT}: ${NTI_LINUX_CONFIGURED}
	...
	( cd ${EXTTEMP}/${NTI_LINUX_TEMP} || exit 1 ;\
		...
		make CONFIG_SHELL=${NTI_TC_ROOT}/bin/bash \
	)
...
ALL_NTI_TARGETS+= nti-bash nti-perl nti-linux
