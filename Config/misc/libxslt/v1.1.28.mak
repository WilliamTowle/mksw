# libxslt v1.1.28		[ since v1.1.28, c. 2015-10-15 ]
...
URLS+= ftp://xmlsoft.org/libxml2/libxslt-1.1.28.tar.gz

#include ${CFG_ROOT}/gui/x11proto/v7.0.23.mak
include ${CFG_ROOT}/misc/libxml2/v2.9.2.mak
...
#		mkdir -p ` dirname ${NTI_LIBXSLT_INSTALLED} ` ;\
#		cp	${NTI_TC_ROOT}/usr/lib/pkgconfig/libxslt.pc \
#			${NTI_TC_ROOT}/usr/lib/pkgconfig/libexslt.pc \
#			` dirname ${NTI_LIBXSLT_INSTALLED} ` \
