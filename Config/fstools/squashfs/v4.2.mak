# squashfs v4.2			[ since v4.0, 2010-01-21 ]
# last mod WmT, 2013-09-16	[ (c) and GPLv2 1999-2013 ]
...
URLS+= http://downloads.sourceforge.net/project/squashfs/squashfs/squashfs${SQUASHFS_VERSION}/squashfs${SQUASHFS_VERSION}.tar.gz?use_mirror=sunet
