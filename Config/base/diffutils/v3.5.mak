# diffutils v3.5		[ since v?.?.?, c.????-??-?? ]
# last mod WmT, 2017-01-27	[ (c) and GPLv2 1999-2017* ]
...
#URLS+= https://ftp.gnu.org/gnu/diffutils/diffutils-${DIFFUTILS_VERSION}.tar.gz
URLS+= https://ftp.gnu.org/gnu/diffutils/diffutils-${DIFFUTILS_VERSION}.tar.xz
...
NTI_DIFFUTILS_INSTALLED=${NTI_TC_ROOT}/bin/diff
