# libxmp v4.3.13		[ since v4.3.1, c.2014-11-20 ]
...
URLS+= 'http://downloads.sourceforge.net/project/xmp/libxmp/${LIBXMP_VERSION}/libxmp-${LIBXMP_VERSION}.tar.gz'
