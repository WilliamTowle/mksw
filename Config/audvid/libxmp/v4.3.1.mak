# libxmp v4.3.1			[ since v4.3.1, c.2014-11-20 ]
# last mod WmT, 2014-11-20	[ (c) and GPLv2 1999-2014* ]
...
URLS+= 'http://downloads.sourceforge.net/project/xmp/libxmp/4.3.1/libxmp-4.3.1.tar.gz?r=&ts=1416491480&use_mirror=ignum'
...
NTI_LIBXMP_CONFIGURED=${EXTTEMP}/${NTI_LIBXMP_TEMP}/config.status
...
.PHONY: nti-libxmp
nti-libxmp: nti-libtool ${NTI_LIBXMP_INSTALLED}
