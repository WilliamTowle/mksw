# libogg v1.3.2			[ since v1.0, c.2003-07-04 ]
...
URLS+= http://downloads.xiph.org/releases/ogg/libogg-${LIBOGG_VERSION}.tar.gz
...
.PHONY: nti-libogg
nti-libogg: nti-libtool nti-pkg-config \
	${NTI_LIBOGG_INSTALLED}
