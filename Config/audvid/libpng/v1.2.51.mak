# libpng v1.2.51		[ since v1.2.5, c.2003-08-14 ]
...
URLS+= http://prdownloads.sourceforge.net/libpng/libpng-${LIBPNG_VERSION}.tar.bz2?download
...
#NTI_LIBPNG_BUILT=${EXTTEMP}/${NTI_LIBPNG_TEMP}/libpng12-config
