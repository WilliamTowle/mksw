# alsa-utils v1.0.27.2		[ EARLIEST v1.0.9, ????-??-?? ]
# last mod WmT, 2013-04-05	[ (c) and GPLv2 1999-2014* ]
...
#cui-alsa-utils: cti-libtool cti-pkg-config cui-alsa-lib ${CUI_ALSA_UTILS_INSTALLED}

ALL_CUI_TARGETS+= cui-alsa-utils


.PHONY: nti-alsa-utils
nti-alsa-utils: nti-libtool nti-pkg-config nti-alsa-lib ${NTI_ALSA_UTILS_INSTALLED}
