# freetype v2.4.11		[ since v2.3.9, c.2009-09-08]
...
${NTI_FREETYPE2_INSTALLED}: ${NTI_FREETYPE2_BUILT}
	...
	( cd ${EXTTEMP}/${NTI_FREETYPE2_TEMP} || exit 1 ;\
		make install ;\
		mkdir -p ` dirname ${NTI_FREETYPE2_INSTALLED} ` ;\
		cp ${NTI_TC_ROOT}/usr/lib/pkgconfig/freetype2.pc ${NTI_FREETYPE2_INSTALLED} \
	)

.PHONY: nti-freetype2
nti-freetype2: ${NTI_FREETYPE2_INSTALLED}
#nti-freetype2: pkg-config nti-x11proto-fonts nti-libfontenc ${NTI_FREETYPE2_INSTALLED}
