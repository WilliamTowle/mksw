...
## see linuxfromscratch for reasons for '--with-abi-version=5'
## CPPFLAGS: adding '-P' inhibits gcc 5's new-style "#line" directives
...
#		cp misc/ncurses.pc ${NTI_NCURSES_INSTALLED} \
#			|| exit 1 \
