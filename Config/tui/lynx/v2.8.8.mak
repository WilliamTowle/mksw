# lynx v2.8.8			[ since v2.8.4, c.2003-06-04 ]
...
${NTI_LYNX_EXTRACTED}:
	echo "*** $@ (EXTRACTED) ***"
	[ ! -d ${EXTTEMP}/lynx-2-8-8 ] || rm -rf ${EXTTEMP}/lynx-2-8-8
		...
		CC=${NTI_GCC} \
		  ...
		  PKG_CONFIG_PATH=${NTI_TC_ROOT}/usr/${HOSTSPEC}/lib/pkgconfig \
			./configure \
				...
				--with-screen=ncurses \
				--with-curses-dir=` ${NTI_TC_ROOT}/usr/bin/${HOSTSPEC}-pkg-config --variable=prefix ncurses ` \
				|| exit 1 ;\
