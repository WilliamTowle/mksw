# host-gcc 4.9.4		[ since v2.7.2.3, c.2002-10-14 ]
# last mod WmT, 2017-02-06	[ (c) and GPLv2 1999-2017 ]
...
##include ${CFG_ROOT}/distrotools-ng/host-binutils/v${HAVE_NATIVE_BINUTILS_VER}.mak
##else
##endif
