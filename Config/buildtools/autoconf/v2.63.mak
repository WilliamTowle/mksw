# autoconf v2.63		[ EARLIEST v?.?, c.????-??-?? ]
# last mod WmT, 2014-12-18	[ (c) and GPLv2 1999-2014* ]
...
NTI_AUTOCONF_CONFIGURED=${EXTTEMP}/${NTI_AUTOCONF_TEMP}/config.log
...
${NTI_AUTOCONF_EXTRACTED}:
	...
	bzcat ${AUTOCONF_SRC} | tar xvf - -C ${EXTTEMP}
...
.PHONY: nti-autoconf
nti-autoconf: nti-m4 ${NTI_AUTOCONF_INSTALLED}
