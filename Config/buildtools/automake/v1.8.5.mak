# automake v1.8.5		[ EARLIEST v?.?, c.????-??-?? ]
# last mod WmT, 2013-04-01	[ (c) and GPLv2 1999-2014* ]
...
URLS+= http://www.mirrorservice.org/sites/ftp.gnu.org/gnu/automake/automake-${AUTOMAKE_VERSION}.tar.bz2
...
NTI_AUTOMAKE_CONFIGURED=${EXTTEMP}/${NTI_AUTOMAKE_TEMP}/config.log
NTI_AUTOMAKE_BUILT=${EXTTEMP}/${NTI_AUTOMAKE_TEMP}/automake
...
${NTI_AUTOMAKE_EXTRACTED}:
	...
	bzcat ${AUTOMAKE_SRC} | tar xvf - -C ${EXTTEMP}
