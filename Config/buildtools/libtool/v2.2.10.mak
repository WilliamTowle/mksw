# libtool v2.2.10		[ since v1.4.2, c.2002-10-30 ]
# last mod WmT, 2014-03-05	[ (c) and GPLv2 1999-2014* ]
...
ifeq (${LIBTOOL_VERSION},2.2.10)
CTI_LIBTOOL_PATCHES=${SOURCES}/l/buildroot-libtool-v2.2.patch
endif
