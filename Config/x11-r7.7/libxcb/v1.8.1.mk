# libxcb v1.8.1			[ since v1.9	2013-01-04 ]
...
include ${MF_CONFIGDIR}/x11-r7.7/libpthread-stubs/v0.3.mk
include ${MF_CONFIGDIR}/x11-r7.7/libXau/v1.0.7.mk
include ${MF_CONFIGDIR}/x11-r7.7/x11proto-xcb/v1.7.1.mk
