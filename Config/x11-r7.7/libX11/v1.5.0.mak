...
URLS+= http://www.x.org/releases/X11R7.7/src/lib/libX11-1.5.0.tar.bz2
...
## [2013-05-26] xcb (--without-xcb) unavoidable for v1.5.0+
...
nti-libX11: nti-pkg-config \
	nti-libXau nti-libxcb \
	nti-x11proto nti-x11proto-xcmisc nti-x11proto-bigreqs \
		nti-x11proto-kb nti-x11proto-input \
