...
EMPTY:=
SPACE:=$(EMPTY) $(EMPTY)
TRACE:= $(shell echo "SANITY: Testing TARGSPEC '${TARGSPEC}'" 1>&2)
...
TRACE:= $(shell echo "SANITY: TARGSPEC adjusted to '${TARGSPEC}'" 1>&2)
endif
...
include ${CFG_ROOT}/portlx-gcc48/kernel.mak
include ${CFG_ROOT}/portlx-gcc48/ucldev.mak
include ${CFG_ROOT}/portlx-gcc48/uclrt.mak
include ${CFG_ROOT}/portlx-gcc48/xbinu.mak
include ${CFG_ROOT}/portlx-gcc48/xgcc.mak
include ${CFG_ROOT}/portlx-gcc48/xkgcc.mak
# Need to build libgcc separately for uClibc 0.9.33.2 (0.9.30+?)
include ${CFG_ROOT}/portlx-gcc48/xlibgcc.mak
include ${CFG_ROOT}/portlx-gcc48/bbox.mak
