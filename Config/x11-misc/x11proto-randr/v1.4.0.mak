# x11proto-randr v1.4.0		[ since v1.3.1, c.2013-03-03 ]
...
#DESCRLIST+= "'cti-x11proto-randr' -- x11proto-randr"

ifeq (${X11PROTO_RANDR_VERSION},)
#X11PROTO_RANDR_VERSION=1.3.1
X11PROTO_RANDR_VERSION=1.4.0
endif
...
URLS+= http://www.x.org/releases/individual/proto/randrproto-1.4.0.tar.bz2
...
#		mkdir -p ` dirname ${NTI_X11PROTO_RANDR_INSTALLED} ` ;\
#		cp ${NTI_TC_ROOT}/usr/lib/pkgconfig/randrproto.pc ${NTI_X11PROTO_RANDR_INSTALLED} \
