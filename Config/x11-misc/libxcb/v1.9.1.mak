# libxcb v1.9.1			[ since v1.9, c.2013-01-04 ]
...
ifeq (${LIBXCB_VERSION},)
#LIBXCB_VERSION=1.7
LIBXCB_VERSION=1.9.1
endif

LIBXCB_SRC=${SOURCES}/l/libxcb-1.9.1.tar.bz2
...
URLS+= http://www.x.org/releases/X11R7.7/src/xcb/libxcb-1.9.1.tar.bz2

http://www.x.org/releases/individual/xcb/libxcb-1.9.1.tar.bz2
include ${CFG_ROOT}/gui/x11proto/v7.0.28.mak
include ${CFG_ROOT}/gui/x11proto-xcb/v1.8.mak
