# xorg-server v1.19.3		[ earliest v1.5.1, since c. 2011-09-23 ]
...
XORG_SERVER_VERSION=1.19.3
endif

#XORG_SERVER_SRC=${SOURCES}/x/xorg-server-${XORG_SERVER_VERSION}.tar.bz2
XORG_SERVER_SRC=${SOURCES}/x/xorg-server_1.19.3.orig.tar.gz
...
URLS+= http://www.mirrorservice.org/sites/ftp.debian.org/debian/pool/main/x/xorg-server/xorg-server_1.19.3.orig.tar.gz
...
${NTI_XORG_SERVER_EXTRACTED}:
	...
	zcat ${XORG_SERVER_SRC} | tar xvf - -C ${EXTTEMP}
