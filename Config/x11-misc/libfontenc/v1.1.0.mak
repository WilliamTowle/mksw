# libfontenc v1.1.0		[ since v1.0.5, c.2013-01-04 ]
...
LIBFONTENC_VERSION=1.1.0
endif

LIBFONTENC_SRC=${SOURCES}/l/libfontenc-${LIBFONTENC_VERSION}.tar.bz2
#URLS+= http://www.x.org/releases/X11R7.5/src/lib/libfontenc-1.0.5.tar.bz2
URLS+= http://www.x.org/releases/individual/lib/libfontenc-1.1.0.tar.bz2
...
#		mkdir -p ` dirname ${NTI_LIBFONTENC_INSTALLED} ` ;\
#		cp ${NTI_TC_ROOT}/usr/lib/pkgconfig/fontenc.pc ${NTI_LIBFONTENC_INSTALLED} \
