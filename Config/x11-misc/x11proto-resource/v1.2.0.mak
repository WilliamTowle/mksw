# x11proto-resource v1.2.0	[ since v1.1.0, c.2013-03-03 ]
...
#X11PROTO_RESOURCE_VERSION=1.1.0
X11PROTO_RESOURCE_VERSION=1.2.0
endif
...
URLS+= http://www.x.org/releases/individual/proto/resourceproto-1.2.0.tar.bz2
...
#		mkdir -p ` dirname ${NTI_X11PROTO_RESOURCE_INSTALLED} ` ;\
#		cp ${NTI_TC_ROOT}/usr/lib/pkgconfig/resourceproto.pc ${NTI_X11PROTO_RESOURCE_INSTALLED} \
