# x11proto-video v2.3.1		[ since v2.3.0, c.2013-03-03 ]
...
URLS+= http://www.x.org/releases/individual/proto/videoproto-${X11PROTO_VIDEO_VERSION}.tar.bz2
...
#		mkdir -p ` dirname ${NTI_X11PROTO_VIDEO_INSTALLED} ` ;\
#		cp ${NTI_TC_ROOT}/usr/lib/pkgconfig/videoproto.pc ${NTI_X11PROTO_VIDEO_INSTALLED} \
