# x11proto-fonts v2.1.1		[ since v2.1.0, c.2013-03-03 ]
...
URLS+= http://www.x.org/releases/individual/proto/fontsproto-${X11PROTO_FONTS_VERSION}.tar.bz2
...
#		mkdir -p ` dirname ${NTI_X11PROTO_FONTS_INSTALLED} ` ;\
#		cp ${NTI_TC_ROOT}/usr/lib/pkgconfig/fontsproto.pc ${NTI_X11PROTO_FONTS_INSTALLED} \
