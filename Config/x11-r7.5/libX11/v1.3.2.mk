...
# last mod WmT, 2024-04-08	[ (c) and GPLv2 1999-2024 ]
...
include ${MF_CONFIGDIR}/x11-r7.5/libxcb/v1.4.mk
...
include ${MF_CONFIGDIR}/x11-r7.5/x11proto/v7.0.16.mk
#| #include ${CFG_ROOT}/x11-r7.6/x11proto-bigreqs/v1.1.1.mak
#| include ${CFG_ROOT}/x11-r7.7/x11proto-bigreqs/v1.1.2.mak
include ${MF_CONFIGDIR}/x11-r7.5/x11proto-bigreqs/v1.1.0.mk
#| #include ${CFG_ROOT}/x11-r7.6/x11proto-input/v2.0.1.mak
#| include ${CFG_ROOT}/x11-r7.7/x11proto-input/v2.2.mak
include ${MF_CONFIGDIR}/x11-r7.5/x11proto-input/v2.0.mk
#| #include ${CFG_ROOT}/x11-r7.6/x11proto-kb/v1.0.5.mak
#| include ${CFG_ROOT}/x11-r7.7/x11proto-kb/v1.0.6.mak
include ${MF_CONFIGDIR}/x11-r7.5/x11proto-kb/v1.0.4.mk
#| #include ${CFG_ROOT}/x11-r7.6/x11proto-xcmisc/v1.2.1.mak
#| include ${CFG_ROOT}/x11-r7.7/x11proto-xcmisc/v1.2.2.mak
include ${MF_CONFIGDIR}/x11-r7.5/x11proto-xcmisc/v1.2.0.mk
include ${MF_CONFIGDIR}/x11-r7.5/x11proto-xext/v7.1.1.mk
include ${MF_CONFIGDIR}/x11-r7.5/xtrans/v1.2.5.mk
...
## [2013-05-26] xcb (--without-xcb) possible until for v1.5.0+
...
${NTI_LIBX11_CONFIGURED}: ${NTI_LIBX11_EXTRACTED}
	...
	( cd ${NTI_LIBX11_TEMP} || exit 1 ;\
		...
		;; \
		*) \
			printf 'Unexpected LIBX11_VERSION ${LIBX11_VERSION}' 1>&2 ;\
			exit 1 ;\
		esac \
	)
