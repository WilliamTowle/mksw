...
NTI_XORG_SERVER_CONFIGURED=${EXTTEMP}/${NTI_XORG_SERVER_TEMP}/config.log
NTI_XORG_SERVER_BUILT=${EXTTEMP}/${NTI_XORG_SERVER_TEMP}/hw/kdrive/sdl/Xsdl
NTI_XORG_SERVER_INSTALLED=${NTI_TC_ROOT}/usr/X11R7/bin/Xsdl
...
## 2013-05-12: --disable-config-hal, otherwise needs 'fdi policies'
...
# TODO: devel package provides xorg-server.h
#	cp xorg-server.pc ${NTI_TC_ROOT}/usr/${HOSTSPEC}/lib/pkgconfig
...
nti-xorg-server: nti-pkg-config nti-SDL nti-libX11 nti-libXfont nti-libxkbfile nti-x11proto-randr nti-x11proto-render nti-x11proto-fixes nti-x11proto-damage nti-x11proto-fonts nti-x11proto-video nti-x11proto-resource nti-openssl nti-pixman nti-xkeyboard-config ${NTI_XORG_SERVER_INSTALLED}
