...
nti-xorg-server: nti-pkg-config \
	nti-libX11 nti-libXfont nti-libXrender nti-openssl nti-pixman \
	nti-libxkbfile nti-x11proto-randr nti-x11proto-render nti-x11proto-fixes nti-x11proto-damage nti-x11proto-fonts nti-x11proto-video nti-x11proto-resource \
