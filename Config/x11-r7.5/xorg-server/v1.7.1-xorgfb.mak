# xorg-server v1.7.1		[ earliest v1.5.1, since c. 2011-09-23 ]
...
include ${CFG_ROOT}/x11-r7.5/libpciaccess/v0.10.9.mak
...
#include ${CFG_ROOT}/x11-r7.5/xf86-input-mouse/v1.5.0.mak
...
## 2013-03-03: exclude Mesa support with '--disable-glx', dri, dri2
...
#nti-xorg-server: nti-pkg-config nti-libX11 nti-libXfont nti-libxkbfile nti-x11proto-randr nti-x11proto-render nti-x11proto-fixes nti-x11proto-damage nti-x11proto-fonts nti-x11proto-video nti-x11proto-resource nti-openssl nti-pixman nti-x11pciaccess nti-xkeyboard-config nti-xf86-input-mouse nti-xf86-input-keyboard nti-xf86-video-fbdev nti-xf86-video-vesa ${NTI_XORG_SERVER_INSTALLED}
